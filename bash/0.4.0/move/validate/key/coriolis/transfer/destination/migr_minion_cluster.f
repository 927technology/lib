move.validate.key.coriolis_transfer_destination_migr_minion_cluster() {
  # local variables
  local _count=0
  local _key=.coriolis.transfer.destination.migr_minion_cluster
  local _type=migr_minion_cluster
